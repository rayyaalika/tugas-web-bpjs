...
<?php
    ...
    ?>
    <center>
        <h3>MENGHITUNG JAMINAN KEMATIAN</h3>
   

    <div>
        <form action="jkm.php" method="post">
        <label>Nama</label>
        <br>
        ...
        if(isset($_POST['submit'])){
            ...
            $iuran_jkm = (0.3/100)*$gaji;
            echo "Iuran yang harus dibayarkan ".$perusahaan." untuk jaminan kematian ".$nama." adalah = Rp.".$iuran_jkm." per bulan";
        }
        ?>
    </div>
    </center>
