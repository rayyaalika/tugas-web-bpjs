...
<?php
    ...
    ?>
    <center>
        <h3>MENGHITUNG JAMINAN HARI TUA</h3>
   

    <div>
        <form action="jht.php" method="post">
        <label>Nama</label>
        <br>
        ...
        if(isset($_POST['submit'])){
            ...
            $iuran = (5.7/100)*$gaji;
            $iuran_jht = (5.7/100)*$gaji;
            $iuran_x = (2/100)*$gaji;
            $iuran_p = (3.7/100)*$gaji;


            echo "Iuran JHT ".$nama." = Rp.".$iuran." per bulan";
            echo "<br>";
            echo "Iuran JHT yang dibayar ".$nama." = Rp.".$iuran_x." per bulan";
            echo "<br>";
            echo "Iuran JHT yang dibayar ".$perusahaan." = Rp.".$iuran_p." per bulan";
        }
        ?>
    </div>
    </center>
